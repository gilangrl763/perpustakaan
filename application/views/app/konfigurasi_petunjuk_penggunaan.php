    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "petunjuk_penggunaan_json/json/?reqToken=<?= $csrf->getToken()?>&STATUS=<?=$STATUS?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0, 1, 2, 3]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/konfigurasi_petunjuk_penggunaan_add.php';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = "app/loadUrl/app/konfigurasi_petunjuk_penggunaan_add/?id=" + anSelectedId;
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("petunjuk_penggunaan_json/aktif", anSelectedId, "Apakah anda ingin mengaktifkan data?", "app/loadUrl/app/konfigurasi_petunjuk_penggunaan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("petunjuk_penggunaan_json/non_aktif", anSelectedId, "Apakah anda ingin menonaktifkan data?", "app/loadUrl/app/konfigurasi_petunjuk_penggunaan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("petunjuk_penggunaan_json/delete", anSelectedId, "app/loadUrl/app/konfigurasi_petunjuk_penggunaan/?id=<?=$id?>");
            });

            $('#STATUS').combobox({
                onSelect: function(param){
                    oTable.fnReloadAjax("petunjuk_penggunaan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS="+$('#STATUS'). combobox('getValues'));
                }
            });
        });
    </script>
                ...
                <div class="konten">
                    ...
                    <section>
                        ...
                        <table id="example" class="display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>PETUNJUK_PENGGUNAAN_ID</th>
                                    <th>STATUS</th>
                                    <th width="10%">Nama</th>
                                    <th width="10%">User</th>
                                    <th width="10%">Keterangan</th>
                                    <th width="10%">Dokumen</th>
                                    <th width="10%">Ukuran Dokumen</th>
