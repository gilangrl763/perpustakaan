...
if ($id == "") {
    ...
    $kondisi_fisik->selectByParams(array("KONDISI_FISIK_ID" => $id));
    // echo $kondisi_fisik->query;
    $kondisi_fisik->firstRow();

    $KODE         = $kondisi_fisik->getField("KODE");
    $NAMA         = $kondisi_fisik->getField("NAMA");
    $KETERANGAN   = $kondisi_fisik->getField("KETERANGAN");
}
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/master_data_kondisi_fisik">Kondisi Fisik</a>
                    &bull; Kelola Kondisi Fisik
                </div>
                <div class="area-form">
                    <div class="konten">
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/master_data_kondisi_fisik_add/?id=' + arrData[2]);
                    }
                }
            });
        }
