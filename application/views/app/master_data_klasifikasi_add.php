...
if ($id == "") {
    ...
    $klasifikasi->selectByParams(array("A.KLASIFIKASI_ID" => $id));
    // echo $klasifikasi->query;
    $klasifikasi->firstRow();

    $KODE                       = $klasifikasi->getField("KODE");
    $NAMA                       = $klasifikasi->getField("NAMA");
    $KLASIFIKASI_ID_PARENT      = $klasifikasi->getField("KLASIFIKASI_ID_PARENT");
    $PERUSAHAAN_ID              = $klasifikasi->getField("PERUSAHAAN_ID");
    $KETERANGAN                 = $klasifikasi->getField("KETERANGAN");
    $RETENSI_AKTIF              = $klasifikasi->getField("RETENSI_AKTIF");
    $RETENSI_INAKTIF            = $klasifikasi->getField("RETENSI_INAKTIF");
    $PENYUSUTAN_AKHIR_ID        = $klasifikasi->getField("PENYUSUTAN_AKHIR_ID");
}
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/master_data_klasifikasi">Klasifikasi</a>
                    &bull; Kelola Klasifikasi
                </div>
                <div class="area-form">
                    <div class="konten">
                        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            valueField:'id',textField:'text',url:'perusahaan_json/combo'" value="<?= $PERUSAHAAN_ID ?>" required />
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <input class="form-control easyui-validatebox" type="text" name="KODE" value="<?= $KODE ?>" required style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2">Klasifikasi Induk</label>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control easyui-combotree" id="KLASIFIKASI_ID_PARENT" name="KLASIFIKASI_ID_PARENT" data-options="width:'715',panelHeight:'120',panelWidth:'715',editable:false,
                                            valueField:'id',textField:'text',url:'klasifikasi_json/combotree'" value="<?= $KLASIFIKASI_ID_PARENT ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <input class="form-control easyui-textbox" type="text" name="NAMA" value="<?= $NAMA ?>" required style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2">Retensi Aktif</label>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-2">
                                            <input class="form-control easyui-numberbox" type="text" name="RETENSI_AKTIF" value="<?= $RETENSI_AKTIF ?>" required style="width:100%">
                                        </div>
                                        <div class="col-md-1">
                                            Tahun
                                        </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2">Retensi Inaktif</label>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-2">
                                            <input class="form-control easyui-numberbox" type="text" name="RETENSI_INAKTIF" value="<?= $RETENSI_INAKTIF ?>" required style="width:100%">
                                        </div>
                                        <div class="col-md-1">
                                            Tahun
                                        </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2">Penyusutan Akhir</label>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-2">
                                            <input type="text" class="form-control easyui-combobox" id="PENYUSUTAN_AKHIR_ID" name="PENYUSUTAN_AKHIR_ID" data-options="width:'200',panelHeight:'120',panelWidth:'200',editable:false,
                                            valueField:'id',textField:'text',url:'penyusutan_akhir_json/combo'" value="<?= $PENYUSUTAN_AKHIR_ID ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <textarea name="KETERANGAN" style="height:100px; width:100%;"><?= $ALAMAT ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/master_data_klasifikasi_add/?id=' + arrData[2]);
                    }
                }
            });
        }
