...
if ($id == "") {
    ...
    $tingkat_perkembangan->selectByParams(array("TINGKAT_PERKEMBANGAN_ID" => $id));
    // echo $tingkat_perkembangan->query;
    $tingkat_perkembangan->firstRow();

    $KODE         = $tingkat_perkembangan->getField("KODE");
    $NAMA         = $tingkat_perkembangan->getField("NAMA");
    $KETERANGAN       = $tingkat_perkembangan->getField("KETERANGAN");
}
?>
...
<body>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/master_data_tingkat_perkembangan">Tingkat Perkembangan</a>
                    &bull; Kelola Tingkat Perkembangan
                </div>
                <div class="area-form">
                    <div class="konten">
    ...
    <script>
        function submitForm() {
            $('#ff').form('submit', {
                url: 'tingkat_perkembangan_json/add',
                onSubmit: function() {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/master_data_tingkat_perkembangan_add/?id=' + arrData[2]);
                    }
                }
            });
        }
