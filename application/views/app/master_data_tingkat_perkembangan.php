    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "tingkat_perkembangan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS=<?= $STATUS ?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0, 1]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/master_data_tingkat_perkembangan_add';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href='app/loadUrl/app/master_data_tingkat_perkembangan_add/?id='+anSelectedId;
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("tingkat_perkembangan_json/delete",anSelectedId,"app/loadUrl/app/master_data_tingkat_perkembangan/?STATUS="+$('#STATUS').combobox('getValues'));
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("tingkat_perkembangan_json/aktif",anSelectedId,"Apakah anda ingin mengaktifkan data?","app/loadUrl/app/master_data_tingkat_perkembangan/?STATUS="+$('#STATUS').combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("tingkat_perkembangan_json/non_aktif",anSelectedId,"Apakah anda ingin menonaktifkan data?","app/loadUrl/app/master_data_tingkat_perkembangan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });

            $('#STATUS').combobox({
                onSelect: function(param) {
                    oTable.fnReloadAjax("tingkat_perkembangan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS="+$('#STATUS').combobox('getValues'));
                }
            });
        });
    </script>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">Tingkat Perkembangan</div>
                <div class="konten">
