...
if ($id == "") {
    ...
    $petunjuk_penggunaan->selectByParams(array("PETUNJUK_PENGGUNAAN_ID" => $id));
    // echo $petunjuk_penggunaan->query;exit;
    $petunjuk_penggunaan->firstRow();
    ...
    $STATUS                 = $petunjuk_penggunaan->getField("STATUS");
}
?>
...
<head>
    ...
    <script>
        function submitForm() {
            $('#ff').form('submit', {
                url: 'petunjuk_penggunaan_json/add',
                onSubmit: function() {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/konfigurasi_petunjuk_penggunaan_add/?id=' + arrData[2]);
                    }
                }
            });
        }
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/konfigurasi_petunjuk_penggunaan.php">Petunjuk Penggunaan</a>
                    &bull; Form Petunjuk Penggunaan
                </div>
                <div class="area-form">
                    <div class="konten">
                        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class='col-md-10'>
                                    <div class='form-group'>
                                        <div class='col-md-6'>
                                            <input class="easyui-textbox col-md-4" type="text" name="NAMA" value="<?= $NAMA ?>" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                        <input class="form-control easyui-validatebox" type="text" id="USER_GROUP" name="USER_GROUP" 
                                            value="<?= $this->USER_GROUP ?>" readonly style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="KETERANGAN" class="control-label col-md-2">File Dokumen</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <div class="col-md-11">
                                            ...
                                            <?
                                            if (file_exists('uploads/petunjuk_penggunaan/'. $DOKUMEN)) {
                                            ?>
                                                <br><a href="uploads/petunjuk_penggunaan/<?= $DOKUMEN ?>" target="_blank"><?= $DOKUMEN ?></a>
                                            <?
                                            }
                                            ?>
