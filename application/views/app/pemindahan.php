    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "pemindahan_json/json/?reqToken=<?= $csrf->getToken()?>&STATUS=<?=$STATUS?>",
                columnDefs: [{
                    className: 'never',
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/pemindahan_add';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = "app/loadUrl/app/pemindahan_add/?id=" + anSelectedId;
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("pemindahan_json/aktif", anSelectedId, "Apakah anda ingin mengaktifkan data?", "app/loadUrl/app/konfigurasi_pemindahan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("pemindahan_json/non_aktif", anSelectedId, "Apakah anda ingin menonaktifkan data?", "app/loadUrl/app/konfigurasi_pemindahan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("pemindahan_json/delete", anSelectedId, "app/loadUrl/app/konfigurasi_pemindahan/?id=<?=$id?>");
            });

            $('#STATUS').combobox({
                onSelect: function(param){
                    oTable.fnReloadAjax("pemindahan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS="+$('#STATUS'). combobox('getValues'));
                }
            });
        });
    </script>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">Pemindahan</div>
                <div class="konten">
