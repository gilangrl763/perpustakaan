...
if ($id == "") {
    ...
    $faq->selectByParams(array("FAQ_ID" => $id));
    // echo $faq->query;exit;
    $faq->firstRow();

    $FAQ_ID        = $faq->getField("FAQ_ID");
    $PERTANYAAN    = $faq->getField("PERTANYAAN");
    $JAWABAN       = $faq->getField("JAWABAN");
}
?>
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/konfigurasi_faq_add/?id=' + arrData[2]);
                    }
                }
            });
        }
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/konfigurasi_faq.php">F.A.Q.</a>
                    &bull; Form F.A.Q.
                </div>
                <div class="area-form">
                    <div class="konten">
                        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class='col-md-10'>
                                    <div class='form-group'>
                                        <div class='col-md-6'>
                                            <input class="easyui-textbox col-md-4" type="text" name="PERTANYAAN" value="<?= $PERTANYAAN ?>" data-options="required:true" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class='col-md-10'>
                                    <div class='form-group'>
                                        <div class='col-md-6'>
                                            <textarea name="JAWABAN" style="height:100px; width:100%;"><?= $JAWABAN ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
