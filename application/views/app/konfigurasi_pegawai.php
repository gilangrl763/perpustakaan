    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "pegawai_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS=<?=$STATUS?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0, 1, 2, 3, 4]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/konfigurasi_pegawai_add';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = 'app/loadUrl/app/konfigurasi_pegawai_add/?id=' + anSelectedId;
            });


            $('#btnHakAksesGedung').on('click', function() {
                if (anSelectedData == "") {
                    $.messager.alert('Informasi', 'Pilih data terlebih dahulu', 'info');
                    return false;
                }

                document.location.href = 'app/loadUrl/app/konfigurasi_pegawai_gedung_add/?id=' + anSelectedId;
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("pegawai_json/delete", anSelectedId, "app/loadUrl/app/konfigurasi_pegawai/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("pegawai_json/aktif", anSelectedId, "Apakah anda ingin mengaktifkan data?", "app/loadUrl/app/konfigurasi_pegawai/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("pegawai_json/non_aktif", anSelectedId, "Apakah anda ingin menonaktifkan data?", "app/loadUrl/app/konfigurasi_pegawai/?STATUS="+$('#STATUS'). combobox('getValues'));
            });

            $('#STATUS').combobox({
                onSelect: function(param){
                    oTable.fnReloadAjax("pegawai_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS="+$('#STATUS'). combobox('getValues'));
                }
            });
        });
    </script>
            ...
            <div class="col-md-12">
                ...
                <div class="konten">
                    <div class="area-menu-aksi">
                        ...
                        <a class="btn btn-secondary" id="btnHakAksesGedung"><i class="fa fa-building"></i> Hak Akses Gedung</a>
