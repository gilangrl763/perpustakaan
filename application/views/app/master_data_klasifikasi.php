...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">Klasifikasi</div>
                <div class="konten">
                    <div class="area-menu-aksi">
                        ...
                        id="PERUSAHAAN_ID" data-options="width:'400',editable:false, valueField:'id',textField:'text',url:'perusahaan_json/combo'" value="<?= $PERUSAHAAN_ID ?>" required />
                    ...
                    <section>
                        <div id="tableContainer" class="tableContainer tableContainer-treegrid">
                            <table id="treeSatker" class="easyui-treegrid" style="min-width:100%;" data-options="
                                    url: 'klasifikasi_json/treetable_master/?PERUSAHAAN_ID=<?= $PERUSAHAAN_ID ?>&STATUS=<?= $STATUS ?>',
                                    dnd: true,
                                    animate:true,           
                                    pagination: true,            
                                    pageSize: 500,
                                ...
                                <thead>
                                    <tr>
                                        <th data-options="field:'NAMA'">Klasifikasi</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $('#PERUSAHAAN_ID').combobox({
                onSelect: function(param) {
                    var urlApp = "klasifikasi_json/treetable_master/?PERUSAHAAN_ID=" + $('#PERUSAHAAN_ID').combobox('getValue') +
            ...
            $('input[name=PENCARIAN]').keyup(function() {
                ...
                var urlApp = 'klasifikasi_json/treetable_master/?PENCARIAN=' + value;
                $('#treeSatker').treegrid({
                    url: urlApp
                });
            });
            ...
            $('#treeSatker').treegrid({
                onDblClickRow: function(param) {
                    document.location.href = "app/index/master_data_klasifikasi_add/?reqId=" + param.id;
                },
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = "app/loadUrl/app/master_data_klasifikasi_add/";
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = "app/loadUrl/app/master_data_klasifikasi_add/?id=" + anSelectedId;
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("klasifikasi_json/aktif", anSelectedId, "Apakah anda ingin mengaktifkan data?", "app/loadUrl/app/konfigurasi_satuan_kerja/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("klasifikasi_json/non_aktif", anSelectedId, "Apakah anda ingin menonaktifkan data?", "app/loadUrl/app/konfigurasi_satuan_kerja/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("klasifikasi_json/delete", anSelectedId, "app/loadUrl/app/konfigurasi_satuan_kerja/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
        });
    </script>
</body>
