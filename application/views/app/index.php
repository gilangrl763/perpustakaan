...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="app/loadUrl/app/home" target="mainFrame">
          <img src="images/logo-aplikasi.png" alt="logo">
        </a>
      </div>
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              <div class="foto"><?= generateFoto($this->ID, $this->NAMA_PEGAWAI) ?></div>
              <div class="info">
                <div class="nama"><?= $this->NAMA_PEGAWAI ?></div>
          ...
          <!-----ROLE----->
          <?
          $arrMultirole = explode(",", $this->MULTIROLE);
          $jumlahRole = count($arrMultirole);
          if ($jumlahRole != 0 || $this->MULTIROLE != "") {
          ?>
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <ul class="dropdown-menu">
                ...
                for ($i = 0; $i < count($arrMultirole); $i++) {
                  $labelRole = str_replace("_", " ", $arrMultirole[$i]);
                ?>
                  <li><a href="javascript:void(0);" onclick="ubahRole('<?= $arrMultirole[$i] ?>','<?= $labelRole ?>')"><?= $labelRole ?></a></li>
                <?
                }
                ?>
              </ul>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">&copy; <?= date("Y") ?>. <b>PT Trans Marga Jateng</b>. All Rights Reserved</div>
    <div class="menu-lain">
