    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "faq_json/json/?reqToken=<?= $csrf->getToken()?>&STATUS=<?= $STATUS ?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0, 1]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/konfigurasi_faq_add.php?reqMode=insert';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = "app/loadUrl/app/konfigurasi_faq_add/?id=" + anSelectedId;
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("faq_json/delete", anSelectedId, "app/loadUrl/app/konfigurasi_faq/?id=<?= $id ?>");
            });

            $('#STATUS').combobox({
                onSelect: function(param) {
                    oTable.fnReloadAjax("faq_json/json/?reqToken=<?= $csrf->getToken() ?>&STATUS=" + $('#STATUS').combobox('getValues'));
                }
            });
        });
    </script>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">F.A.Q.</div>
                <div class="konten">
