    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "lokasi_simpan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS=<?= $STATUS ?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0, 1, 2, 3]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/master_data_lokasi_simpan_add';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href='app/loadUrl/app/master_data_lokasi_simpan_add/?id='+anSelectedId;
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("lokasi_simpan_json/delete",anSelectedId,"app/loadUrl/app/master_data_lokasi_simpan/?STATUS="+$('#STATUS').combobox('getValues'));
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("lokasi_simpan_json/aktif",anSelectedId,"Apakah anda ingin mengaktifkan data?","app/loadUrl/app/master_data_lokasi_simpan/?STATUS="+$('#STATUS').combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("lokasi_simpan_json/non_aktif",anSelectedId,"Apakah anda ingin menonaktifkan data?","app/loadUrl/app/master_data_lokasi_simpan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });

            $('#STATUS').combobox({
                onSelect: function(param) {
                    oTable.fnReloadAjax("lokasi_simpan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS="+$('#STATUS').combobox('getValues'));
                }
            });
        });
    </script>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">Lokasi Simpan</div>
                <div class="konten">
                        ...
                        <table id="example" class="display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%">Nomor Boks</th>
                                    <th width="20%">Nomor Folder</th>
