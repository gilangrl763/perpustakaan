...
$this->load->model("UsulMusnah");
$usul_musnah = new UsulMusnah();
...
if ($id == "") {
    ...
    $usul_musnah->selectByParams(array("A.USUL_MUSNAH_ID" => $id));
    // echo $usul_musnah->query;exit;
    $usul_musnah->firstRow();
    $PEMINDAHAN_ID          = $usul_musnah->getField("PEMINDAHAN_ID");
    $KETERANGAN             = $usul_musnah->getField("KETERANGAN");
    $DOKUMEN                = $usul_musnah->getField("DOKUMEN");    
}
?>
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/usul_musnah_add/?id=' + arrData[2]);
                    }
                }
            });
        }
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/usul_musnah">Usul Musnah</a>
                    &bull; Form Usul Musnah
                </div>
                <div class="area-form">
                    <div class="konten">
                        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control easyui-combobox" id="PEMINDAHAN_ID" 
                                            name="PEMINDAHAN_ID" data-options="width:'250',panelHeight:'120',panelWidth:'250',editable:false,
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <div class="col-md-11">
                                            ...
                                            <?
                                            if (file_exists('uploads/usul_musnah/'. $DOKUMEN)) {
                                            ?>
                                                <br><a href="uploads/usul_musnah/<?= $DOKUMEN ?>" target="_blank"><?= $DOKUMEN ?></a>
                                            <?
                                            }
                                            ?>
