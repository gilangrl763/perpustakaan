    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "banner_json/json/?reqToken=<?=$csrf->getToken()?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/konfigurasi_banner_add.php?reqMode=insert';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = "app/loadUrl/app/konfigurasi_banner_add/?id=" + anSelectedId;
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("banner_json/delete", anSelectedId, "app/loadUrl/app/konfigurasi_banner/?id=<?= $id ?>");
            });
        });
    </script>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">Banner</div>
                <div class="konten">
