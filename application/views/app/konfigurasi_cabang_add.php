...
if ($id == "") {
    ...
    $cabang->selectByParams(array("A.CABANG_ID" => $id));
    // echo $cabang->query;
    $cabang->firstRow();

    $KODE               = $cabang->getField("KODE");
    $NAMA               = $cabang->getField("NAMA");
    $ALAMAT             = $cabang->getField("ALAMAT");
    $TELEPON            = $cabang->getField("TELEPON");
    $EMAIL              = $cabang->getField("EMAIL");
    $PERUSAHAAN_ID      = $cabang->getField("PERUSAHAAN_ID");
}
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/konfigurasi_cabang">Cabang</a>
                    &bull; Kelola Cabang
                </div>
                <div class="area-form">
                    <div class="konten">
                        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control easyui-combotree" id="PERUSAHAAN_ID" name="PERUSAHAAN_ID" data-options="width:'715',panelHeight:'120',panelWidth:'715',editable:false,
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            value="<?= $TELEPON ?>" data-options="required:true" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            value="<?= $EMAIL ?>" data-options="required:true" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/konfigurasi_cabang_add/?id=' + arrData[2]);
                    }
                }
            });
        }
