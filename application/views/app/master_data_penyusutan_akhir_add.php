...
if ($id == "") {
    ...
    $penyusutan_akhir->selectByParams(array("PENYUSUTAN_AKHIR_ID" => $id));
    // echo $penyusutan_akhir->query;
    $penyusutan_akhir->firstRow();

    $KODE         = $penyusutan_akhir->getField("KODE");
    $NAMA         = $penyusutan_akhir->getField("NAMA");
    $KETERANGAN       = $penyusutan_akhir->getField("KETERANGAN");
}
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/master_data_penyusutan_akhir">Penyusutan Akkhir</a>
                    &bull; Kelola Penyusutan Akkhir
                </div>
                <div class="area-form">
                    <div class="konten">
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/master_data_penyusutan_akhir_add/?id=' + arrData[2]);
                    }
                }
            });
        }
