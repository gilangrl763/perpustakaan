    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "usul_musnah_json/json/?reqToken=<?= $csrf->getToken()?>&STATUS=<?=$STATUS?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0, 1, 2]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/usul_musnah_add';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = "app/loadUrl/app/usul_musnah_add/?id=" + anSelectedId;
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("usul_musnah_json/aktif", anSelectedId, "Apakah anda ingin mengaktifkan data?", "app/loadUrl/app/usul_musnah/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("usul_musnah_json/non_aktif", anSelectedId, "Apakah anda ingin menonaktifkan data?", "app/loadUrl/app/usul_musnah/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("usul_musnah_json/delete", anSelectedId, "app/loadUrl/app/usul_musnah/?id=<?=$id?>");
            });

            $('#STATUS').combobox({
                onSelect: function(param){
                    oTable.fnReloadAjax("usul_musnah_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS="+$('#STATUS'). combobox('getValues'));
                }
            });
        });
    </script>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">Usul Musnah</div>
                <div class="konten">
