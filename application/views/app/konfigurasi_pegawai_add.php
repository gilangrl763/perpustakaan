...
if ($id == "") {
    ...
    $pegawai->selectByParams(array("A.PEGAWAI_ID" => $id));
    // echo $pegawai->query;
    $pegawai->firstRow();

    $KODE               = $pegawai->getField("KODE");
    $NAMA               = $pegawai->getField("NAMA");
    $JABATAN            = $pegawai->getField("JABATAN");
    $JENIS_PEGAWAI      = $pegawai->getField("JENIS_PEGAWAI");
    $JENIS_KELAMIN      = $pegawai->getField("JENIS_KELAMIN");
    $TEMPAT_LAHIR       = $pegawai->getField("TEMPAT_LAHIR");
    $TANGGAL_LAHIR      = $pegawai->getField("TANGGAL_LAHIR");
    $ALAMAT             = $pegawai->getField("ALAMAT");
    $TELEPON            = $pegawai->getField("TELEPON");
    $EMAIL              = $pegawai->getField("EMAIL");
    $PERUSAHAAN_ID      = $pegawai->getField("PERUSAHAAN_ID");
    $CABANG_ID          = $pegawai->getField("CABANG_ID");
    $SATUAN_KERJA_ID    = $pegawai->getField("SATUAN_KERJA_ID");
    $KATEGORI_PEGAWAI   = $pegawai->getField("KATEGORI_PEGAWAI");
}
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">
                    <a href="app/loadUrl/app/konfigurasi_pegawai">Pegawai</a>
                    &bull; Kelola Pegawai
                </div>
                <div class="area-form">
                    <div class="konten">
                        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            value="<?= $KODE ?>" required style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class='col-md-10'>
                                    <div class='form-group'>
                                        <div class='col-md-6'>
                                            <input class="form-control easyui-textbox" type="text" name="JABATAN" 
                                            value="<?= $JABATAN ?>" required style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class='col-md-10'>
                                    <div class='form-group'>
                                        <div class='col-md-6'>
                                            <input type="text" class="form-control easyui-combotree" id="JENIS_PEGAWAI" 
                                            name="JENIS_PEGAWAI" data-options="width:'725',panelHeight:'120',panelWidth:'725',editable:false,
                                            valueField:'id',textField:'text',url:'combo_json/comboJenisPegawai'" value="<?= $JENIS_PEGAWAI ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <input type="text" class="form-control easyui-combotree" id="JENIS_KELAMIN" 
                                            name="JENIS_KELAMIN" data-options="width:'725',panelHeight:'120',panelWidth:'725',editable:false,
                                            valueField:'id',textField:'text',url:'combo_json/comboJenisKelamin'" value="<?= $JENIS_KELAMIN ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class='col-md-10'>
                                    <div class='form-group'>
                                        <div class='col-md-6'>
                                            <input class="form-control easyui-textbox" type="text" name="TEMPAT_LAHIR" 
                                            value="<?= $TEMPAT_LAHIR ?>" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class='col-md-10'>
                                    <div class='form-group'>
                                        <div class='col-md-6'>
                                            <input class="form-control easyui-datebox" type="text" name="TANGGAL_LAHIR" 
                                            value="<?=$TANGGAL_LAHIR?>" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                <label for="KATEGORI_PEGAWAI" class="control-label col-md-2">Kategori Pegawai</label>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <input type="text" class="form-control easyui-combotree" id="KATEGORI_PEGAWAI" 
                                            name="KATEGORI_PEGAWAI" data-options="width:'725',panelHeight:'120',panelWidth:'725',editable:false,
                                            valueField:'id',textField:'text',url:'combo_json/comboKategoriPegawai'" value="<?= $KATEGORI_PEGAWAI ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <input class="form-control easyui-textbox" type="text" name="TELEPON" 
                                            value="<?=$TELEPON?>" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <input class="form-control easyui-textbox" type="text" name="EMAIL" 
                                            value="<?=$EMAIL?>" data-options="validType:'email'" required style="width:100%">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (arrData[0] == "GAGAL") {
                        ...
                        $.messager.alertLink('Info', arrData[1], 'info', '', 'app/loadUrl/app/konfigurasi_pegawai_add/?id=' + arrData[2]);
                    }
                }
            });
        }
