    ...
    <script type="text/javascript" language="javascript" class="init">
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "perusahaan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS=<?=$STATUS?>",
                columnDefs: [{
                    className: 'never',
                    targets: [0, 1]
                }],
            ...
            $('#btnAdd').on('click', function() {
                document.location.href = 'app/loadUrl/app/konfigurasi_perusahaan_add';
            });
            ...
            $('#btnEdit').on('click', function() {
                ...
                document.location.href = 'app/loadUrl/app/konfigurasi_perusahaan_add/?id='+anSelectedId;
            });
            ...
            $('#btnDelete').on('click', function() {
                ...
                deleteData("perusahaan_json/delete", anSelectedId, "app/loadUrl/app/konfigurasi_perusahaan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnAktif').on('click', function() {
                ...
                konfirmasiData("perusahaan_json/aktif", anSelectedId, "Apakah anda ingin mengaktifkan data?", "app/loadUrl/app/konfigurasi_perusahaan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });
            ...
            $('#btnNonAktif').on('click', function() {
                ...
                konfirmasiData("perusahaan_json/non_aktif", anSelectedId, "Apakah anda ingin menonaktifkan data?", "app/loadUrl/app/konfigurasi_perusahaan/?STATUS="+$('#STATUS'). combobox('getValues'));
            });

            $('#STATUS').combobox({
                onSelect: function(param){
                    oTable.fnReloadAjax("perusahaan_json/json/?reqToken=<?=$csrf->getToken()?>&STATUS="+$('#STATUS'). combobox('getValues'));
                }
            });
        });
    </script>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="judul-halaman">Perusahaan</div>
                <div class="konten">
                    ...
                    <section>
                        <table id="example" class="table table-striped table-hover dt-responsive" width="100%">
                            <thead>
                                <tr>
                                    <th>PERUSAHAAN_ID</th>
                                    <th>STATUS</th>
