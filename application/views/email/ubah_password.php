															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
                                                                        ...
                                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000; text-transform:uppercase; letter-spacing:2px; line-height:135%;">NOTIFIKASI UBAH PASSWORD</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																			...
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																					  ...
																					  <p>Ubah password pada sistem Subsidiary Integration Portal (SIP) PT Angkasa Pura I (Persero) dengan data sebagai berikut :</p>
                                                                                      <table style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;">
                                                                                        ...
                                                                                        <tr>
                                                                                      	...
                                                                                      	<p>Telah berhasil diubah, harap menjaga kerahasiaan data anda dengan baik. Silahkan login dengan password terbaru anda pada sistem <a href="<?=base_url()?>">Subsidiary Integration Portal (SIP)</a> untuk keamanan.</p>
