...
$user_login->selectByParamsMonitoring(array("A.REKANAN_ID" => $reqId));
$user_login->firstRow();
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;"><img src="https://ptbima.id/file/media/source/logobimanew-sd.png" style="margin:0 auto;" /></h1>
																		
                                                                        <h2 class="title-career" style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:22px;margin-bottom:15px;color:#205478;line-height:135%; border-top:1px solid #2b8dce; border-bottom:1px solid #2b8dce; padding-top:10px;padding-bottom:7px;">MARKET PLACE PT BIMA</h2>

                                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000; text-transform:uppercase; letter-spacing:2px; line-height:135%;">NOTIFIKASI REGISTRASI PENYEDIA</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																			...
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																					  <p>Kepada Yth.<br><b><?=$user_login->getField("USER_NAMA")?></b><br>di -tempat<p/>
																					  <p>
																					  Selamat, perusahaan Anda telah terdaftar pada sistem Market Place PT Berkah Industri Mesin Angkat (PT BIMA), dengan data sebagai berikut :</p>
                                                                                      <table style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;">
                                                                                      	...
                                                                                      	<tr>
                                                                                        	...
                                                                                        	<td>:</td>
                                                                                        	<td><?=$user_login->getField("KODE")?></td>
                                                                                        </tr>
                                                                                      	<tr>
                                                                                        	<td>Nama Perusahaan</td>
                                                                                        	<td>:</td>
                                                                                        	<td><?=$user_login->getField("USER_NAMA")?></td>
                                                                                        </tr>
                                                                                      	<tr>
                                                                                        	<td>Username</td>
                                                                                        	<td>:</td>
                                                                                        	<td><?=$user_login->getField("KODE")?> atau <?=$user_login->getField("USER_EMAIL")?></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        	<td>Password</td>
                                                                                        	<td>:</td>
                                                                                      	...
                                                                                      	<p>Silahkan lengkapi data diri perusahaan Anda pada sistem Market Place PT Berkah Industri Mesin Angkat dengan menggunakan <i>USER ID</i> tersebut</p>
                                                                                      	...
                                                                                      	<p style="text-align:justify;color:#5F5F5F">Apabila ada perihal yang ingin ditanyakan lebih lanjut terkait sistem, Anda dapat mengajukan pertanyaan melalui email kepada market-place@ptbima.id</b>.</p>
	                                                                                	...
	                                                                                	<p style="text-align:justify;font-size: 11px;color:#5F5F5F"><b><i>Market Place</i></b><br><b>PT Berkah Industri Mesin Angkat</b><br>Jl. Perak Barat No. 379<br>Perak Utara, Kec. Pabean Cantikan<br>Kota Surabaya, Jawa Timur 60165 - Indonesia<br>Telp. +6231 99093444</p>
																					</div>
																				</td>
																			</tr>
																		</table>
																...
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; <?=date("Y")?> <a href="<?=base_url()?>" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Market Place - PT Berkah Industri Mesin Angkat</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																		</div>
