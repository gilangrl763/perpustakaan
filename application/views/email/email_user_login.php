...
$user_login->selectByParamsMonitoring(array("A.USER_LOGIN_ID" => $id));
$user_login->firstRow();
?>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">
                                                                        <!-- <img src="https://aic.garudapratama.com/images/TMJ/gmf_logo.png" style="display: inline-block; width: 200px; height: auto; object-fit: scale-down; margin:0 auto;" /> -->
                                                                        <img src="https://aic.garudapratama.com/images/TMJ/logo-colored.png" style="display: inline-block; width: 130px; height: auto; object-fit: scale-down; margin:0 auto;" />
                                                                    </h1>

                                                                    <h2 class="title-career" style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:18px;margin-bottom:15px;color:#205478;line-height:135%; border-top:1px solid #2b8dce; border-bottom:1px solid #2b8dce; padding-top:10px;padding-bottom:7px;">Aplikasi Manajemen Kearsipan (TMJ)<br>PT Trans Marga Jateng</h2>

                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000; text-transform:uppercase; letter-spacing:2px; line-height:135%;">RESET PASSWORD</div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- // CONTENT TABLE -->
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #0E3DCE; border-collapse:collapse; width:100%; text-align:center; margin:20px auto">
                                                                                        <tr>
                                                                                            <td align="center" valign="middle" class="buttonContent" style="padding-top:10px;padding-bottom:10px;padding-right:10px;padding-left:10px;">
                                                                                                <a style="color:#fff;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:135%;" href="<?= base_url() ?>" target="_blank">Getting to Aircraft Cleaning Portal (AIC)</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>

                                                                                    <p style="text-align:justify;color:#5F5F5F">If you have further questions regarding the system, you can ask questions via email to helpdesk@garudapratama.com</b>.</p>

                                                                                    <p style="text-align:justify;color:#5F5F5F">Thus conveyed, for your attention and cooperation, thank you.</p>

                                                                                    <p style="color:#5F5F5F;margin-top:50px;"><b>Best Regards,</b></p>

                                                                                    <p style="text-align:justify;font-size: 11px;color:#5F5F5F"><b><i>Aircraft Cleaning Portal (AIC)</i></b><br><b>PT Trans Marga Jateng</b><br>Jl. GMF Aeroasia, RT.001/RW.010, Pajang<br>Kec. Benda Kota Tangerang<br>Banten 15126 Indonesia</p>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
