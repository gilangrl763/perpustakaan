...
class TingkatPerkembangan extends Entity
{
	...
	function insert()
	{
		...
		$str = "INSERT INTO TINGKAT_PERKEMBANGAN(
				...
				CREATED_BY, 
				CREATED_DATE)
			VALUES ('" . $this->getField("TINGKAT_PERKEMBANGAN_ID") . "', 
				'" . $this->getField("KODE") . "', 
				'" . $this->getField("NAMA") . "', 
	...
	function update()
	{
		$str = "UPDATE TINGKAT_PERKEMBANGAN
				SET 
	...
	function delete()
	{
		$str = "DELETE FROM TINGKAT_PERKEMBANGAN
			WHERE TINGKAT_PERKEMBANGAN_ID = '" . $this->getField("TINGKAT_PERKEMBANGAN_ID") . "'";
	...
	{
		$str = "  SELECT TINGKAT_PERKEMBANGAN_ID,KODE,NAMA,KETERANGAN,STATUS,CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE
			FROM TINGKAT_PERKEMBANGAN 
			WHERE 1 = 1
		";
	...
	function selectByParamsMonitoring($paramsArray = array(), $limit = -1, $from = -1, $statement = "", $order = " ORDER BY TINGKAT_PERKEMBANGAN_ID ASC")
	{
		$str = " SELECT TINGKAT_PERKEMBANGAN_ID, KODE, NAMA, KETERANGAN,STATUS,CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE
